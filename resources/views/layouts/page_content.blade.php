          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div data-i18n="Authentications">Categorie</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="{{route('categorie')}}" class="menu-link" >
                    <div data-i18n="Basic">Categorie des depenses</div>
                  </a>
                </li>
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div data-i18n="Misc">Depense</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="{{route('depense')}}" class="menu-link">
                    <div data-i18n="Error">Depenses</div>
                  </a>
                </li>
